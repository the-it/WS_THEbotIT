...
for i in range(12, 70, 2):
    ...
    finding = re.findall('<a href="https://upload.wikimedia.org/wikipedia/commons/\w/\w\w/OrbisPictus_b_\d\d\d.jpg"'
                         ' class="internal"'
                         ' title="OrbisPictus b \d\d\d.jpg">Original file</a>', str(response.content))
    url_origin = re.findall('https://upload.wikimedia.org/wikipedia/commons/\w/\w\w/OrbisPictus_b_\d\d\d.jpg',
                            finding[0])
