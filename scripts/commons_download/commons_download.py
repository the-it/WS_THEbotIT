...
for i in range(12, 70, 2):
    print(i)
    if i < 100 : number = '0'+str(i)
    else : number = str(i)
    response = requests.get(url="https://commons.wikimedia.org/wiki/File:OrbisPictus_b_"+number+".jpg",headers={'User-Agent': 'Python-urllib/3.1'}, timeout=2)
