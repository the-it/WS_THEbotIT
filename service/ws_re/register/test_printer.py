...
class TestReRegisterPrinter(BaseTestRegister, TestCloudBase):
    ...
    def test_print_alphabetic(self):
        with mock.patch("service.ws_re.register.printer.Page") as page_mock:
            ...
            compare(
                call(None, "Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/I,1"),
                page_mock.call_args_list[0],
            )
            compare(
                call(None, "Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/III,1"),
    ...
    def test_print_volume(self):
        with mock.patch("service.ws_re.register.printer.Page") as page_mock:
            ...
            compare(
                call(None, "Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/a"),
                page_mock.call_args_list[0],
            )
            compare(
                call(None, "Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/ak"),
                page_mock.call_args_list[1],
            )
            compare(
                call(None, "Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/z"),
    ...
    def test_print_short(self):
        with mock.patch("service.ws_re.register.printer.Page") as page_mock:
            ...
            compare(
                call(None, "Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/I kurz"),
                page_mock.call_args_list[0],
            )
            compare(
                call(None, "Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/XI kurz"),
                page_mock.call_args_list[10],
            )
            compare(
                call(None, "Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/XXI kurz"),
                page_mock.call_args_list[20],
            )
            compare(
                call(None, "Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/VII A kurz"),
                page_mock.call_args_list[30],
            )
            compare(
                call(None, "Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/S VII kurz"),
                page_mock.call_args_list[40],
            )
            compare(
                call(None, "Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/R kurz"),
    ...
    def test_print_pd(self):
        with mock.patch("service.ws_re.register.printer.Page") as page_mock:
            ...
            compare(
                call(
                    None,
                    f"Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/PD {current_year - 5}",
                ),
                page_mock.call_args_list[0],
            )
            compare(
                call(
                    None,
                    f"Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/PD {current_year + 4}",
                ),
    ...
    def test_print_author(self):
        with mock.patch("service.ws_re.register.printer.Page") as page_mock:
            ...
            compare(
                call(None, "Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/Herman Abel"),
                page_mock.call_args_list[0],
            )
            compare(call(None, "Kategorie:RE:Autor:Herman Abel"), page_mock.call_args_list[1])
            compare(
                call(None, "Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/Abert"),
                page_mock.call_args_list[2],
            )
            compare(call(None, "Kategorie:RE:Autor:Abert"), page_mock.call_args_list[3])
            compare(
                call(None, "Paulys Realencyclopädie der classischen Altertumswissenschaft/Register/William Abbott"),
                page_mock.call_args_list[4],
            )
            compare(call(None, "Kategorie:RE:Autor:William Abbott"), page_mock.call_args_list[5])
            compare(
    ...
    def test_print_sortkey_map(self):
        with mock.patch("service.ws_re.register.printer.Page") as page_mock:
            ...
            compare(call(None, "Modul:RE/Sortierschlüssel"), page_mock.call_args_list[0])
