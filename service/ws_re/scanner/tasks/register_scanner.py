...
from service.ws_re.template.re_page import SplittedArticleList
...
class SCANTask(ReScannerTask):
    ...
    def _fetch_wp_link(self, article_list: SplittedArticleList) -> Tuple[LemmaDict, UpdaterRemoveList]:
        article = article_list.first_article
    ...
    def _fetch_ws_link(self, article_list: SplittedArticleList) -> Tuple[LemmaDict, UpdaterRemoveList]:
        article = article_list.SplittedArticleList
    ...
    def _fetch_redirect(self, article_list: SplittedArticleList) -> Tuple[LemmaDict, UpdaterRemoveList]:
        article = article_list.SplittedArticleList
    ...
    @staticmethod
    def _fetch_previous(article_list: SplittedArticleList) -> Tuple[LemmaDict, UpdaterRemoveList]:
        article = article_list.SplittedArticleList
    ...
    @staticmethod
    def _fetch_next(article_list: SplittedArticleList) -> Tuple[LemmaDict, UpdaterRemoveList]:
        article = article_list.SplittedArticleList
    ...
    @staticmethod
    def _fetch_no_creative_height(article_list: SplittedArticleList) -> Tuple[LemmaDict, UpdaterRemoveList]:
        article = article_list.SplittedArticleList
    ...
    def _fetch_pages(self, article_list_dict: SplittedArticleList) -> Tuple[LemmaDict, UpdaterRemoveList]:
    ...
    @staticmethod
    def _fetch_proof_read(article_list: SplittedArticleList) -> Tuple[LemmaDict, UpdaterRemoveList]:
        article = article_list.SplittedArticleList
