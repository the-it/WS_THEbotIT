...
class TestP6216CopyrightStatus(BaseTestClaimFactory):
    PMA_CLAIM_50 = {
        "mainsnak": {
            ...
            "datavalue": {"value": {"entity-type": "item", "numeric-id": 19652}, "type": "wikibase-entityid"},
        },
        "type": "statement",
        "rank": "normal",
        "qualifiers": {
            "P1001": [
                {
                    ...
                    "datatype": "wikibase-item",
                    "datavalue": {
                        "value": {"entity-type": "item", "numeric-id": 59621182},
            ...
            "P459": [
                {
                    ...
                    "datatype": "wikibase-item",
                    "datavalue": {
                        "value": {"entity-type": "item", "numeric-id": 29870405},
                        "type": "wikibase-entityid",
                    },
                }
            ],
    ...
    def test_min_years_since_death_pma_50(self):
        ...
        compare(
            COUNTRIES_WITH_50_YEARS_PMA_OR_SHORTER,
            claim_50["qualifiers"]["P1001"][0]["datavalue"]["value"]["numeric-id"],
        )
        compare(
            FIFTY_YEARS_OR_MORE_AFTER_AUTHORS_DEATH,
    ...
    def test_min_years_since_death_pma_70(self):
        ...
        compare(
            COUNTRIES_WITH_70_YEARS_PMA_OR_SHORTER,
            claim_70["qualifiers"]["P1001"][0]["datavalue"]["value"]["numeric-id"],
        )
        compare(
            SEVENTY_YEARS_OR_MORE_AFTER_AUTHORS_DEATH,
    ...
    def test_min_years_since_death_pma_80(self):
        ...
        compare(
            COUNTRIES_WITH_80_YEARS_PMA_OR_SHORTER,
            claim_80["qualifiers"]["P1001"][0]["datavalue"]["value"]["numeric-id"],
        )
        compare(
            EIGHTY_YEARS_OR_MORE_AFTER_AUTHORS_DEATH,
    ...
    def test_min_years_since_death_pma_100(self):
        ...
        compare(
            COUNTRIES_WITH_100_YEARS_PMA_OR_SHORTER,
            claim_100["qualifiers"]["P1001"][0]["datavalue"]["value"]["numeric-id"],
        )
        compare(
            HUNDRED_YEARS_OR_MORE_AFTER_AUTHORS_DEATH,
            ...
            "P1001": [
                {
                    ...
                    "property": "P1001",
                    "datatype": "wikibase-item",
                    "datavalue": {"value": {"entity-type": "item", "numeric-id": 30}, "type": "wikibase-entityid"},
                }
            ],
            "P459": [
                {
                    ...
                    "datatype": "wikibase-item",
                    "datavalue": {
                        "value": {"entity-type": "item", "numeric-id": 47246828},
                        "type": "wikibase-entityid",
                    },
                }
            ],
            ...
            "P459": [
                {
                    ...
                    "property": "P459",
                    "datatype": "wikibase-item",
                    "datavalue": {"value": {"entity-type": "item", "numeric-id": 707401}, "type": "wikibase-entityid"},
                }
            ]
        },
    ...
    def test_threshold_of_originality(self):
        re_page = self._create_mock_page(
            text="{{REDaten|KEINE_SCHÖPFUNGSHÖHE=ON}}\ntext\n{{REAutor|Blablub}}", title="RE:Bla"
        )
        factory = P6216CopyrightStatus(re_page, self.logger)
    ...
    def test_threshold_of_originality_cross_reference(self):
        re_page = self._create_mock_page(
            text="{{REDaten|BAND=X A|VERWEIS=ON}}\ntext\n{{REAutor|Blablub}}", title="RE:Bla"
        )
        factory = P6216CopyrightStatus(re_page, self.logger)
        compare(self.THRESHOLD_CLAIM, factory._get_claim_json()[0])
