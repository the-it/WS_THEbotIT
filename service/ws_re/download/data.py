...
_MAPPINGS: Dict[str, MappingEntryType] = {
    ...
    "II,2": {"source": ("PaulyWissowa110", "Pauly-Wissowa_1-10", "Artemisia Barbaroi"), "pages": ((1439, 40004, 40359),)},
    "III,1": {"source": ("PaulyWissowa110", "Pauly-Wissowa_1-10", "Barbarus Campanus"), "pages": ((-1, 50002, 50362),)},
    "III,2": {"source": ("PaulyWissowa110", "Pauly-Wissowa_1-10", "Campanus ager Claudius"), "pages": ((1439, 60002, 60004),
                                                                                 (1451, 60006, 60370))},
    "IV,1": {"source": ("PaulyWissowa110", "Pauly-Wissowa_1-10", "Claudius mons Cornificius"), "pages": ((-1, 70002, 70410),)},
    "IV,2": {"source": ("PaulyWissowa110", "Pauly-Wissowa_1-10", "Corniscae Demodoros"), "pages": ((1631, 80002, 80312),)},
