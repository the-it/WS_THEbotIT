...
_MAPPINGS: Dict[str, MappingEntryType] = {
    ...
    "II,2": {
        "source": ("PaulyWissowa110", "Pauly-Wissowa_1-10", "Artemisia Barbaroi"),
        "pages": ((1439, 40004, 40359),),
    },
    "III,1": {"source": ("PaulyWissowa110", "Pauly-Wissowa_1-10", "Barbarus Campanus"), "pages": ((-1, 50002, 50362),)},
    "III,2": {
        "source": ("PaulyWissowa110", "Pauly-Wissowa_1-10", "Campanus ager Claudius"),
        "pages": ((1439, 60002, 60004), (1451, 60006, 60370)),
    },
    "IV,1": {
        "source": ("PaulyWissowa110", "Pauly-Wissowa_1-10", "Claudius mons Cornificius"),
        "pages": ((-1, 70002, 70410),),
    },
    "IV,2": {
        "source": ("PaulyWissowa110", "Pauly-Wissowa_1-10", "Corniscae Demodoros"),
        "pages": ((1631, 80002, 80312),),
    },
    "V,1": {"source": ("PaulyWissowa110", "Pauly-Wissowa_1-10", "Demogenes Ephoroi"), "pages": ((-1, 90002, 90385),)},
    "V,2": {"source": ("PaulyWissowa110", "Pauly-Wissowa_1-10", "Demogenes Ephoroi"), "pages": ((1531, 90385, 90718),)},
    "VI,1": {"source": ("PaulyWissowa110", "Pauly-Wissowa_1-10", "Ephoros-Eutychos"), "pages": ((-1, 2, 386),)},
    "VI,2": {"source": ("PaulyWissowa110", "Pauly-Wissowa_1-10", "Euxantios-Fornaces"), "pages": ((1535, 2, 337),)},
    ...
    "XVIII,2": {
        "source": ("PaulyWissowa3140", "", "Orphische Dichtung Palatini"),
        "pages": ((1319, 3610002, 3610312),),
    },
    ...
    "XXIII,2": {
        "source": ("PaulyWissowa4153", "", "Psamathe Pyramiden"),
        "pages": ((1295, 460002, 460253), (2307, 460254, 460321)),
    },
    ...
    "VII A,2": {
        "source": ("PaulyWissowa5466", "", "Tullius (M. Tullius Cicero) Valerius"),
        "pages": ((1279, 140002, 140321),),
    },
    "VIII A,1": {
        "source": ("PaulyWissowa5466", "", "Valerius Fabrianus P. Vergilius Maro"),
        "pages": ((-1, 150002, 150317),),
    },
    "VIII A,2": {
        "source": ("PaulyWissowa5466", "", "Vergilius (P. Vergilius Maro) Vindeleia"),
        "pages": ((1263, 160002, 160333),),
    },
    "IX A,1": {
        "source": ("PaulyWissowa5466", "", "Vindelici Vulca"),
        "pages": (
            (-1, 170002, 170310),
            (1235, 170312, 170322),
        ),
    ...
    "S XIII": {
        "source": ("PaulySupp", "", "Supp13 Africa Proconsularis Viae publicae Romanae"),
