...
class DateConversion:
    ...
    def __str__(self):
        ...
        match_complete_date = re.search(
            '\d{1,2}(\.|\. | )(\d\d?|Jan|Jän|Feb|Mär|Apr|Mai|Jun|Jul|Aug|Sep|Okt|Nov|Dez)\w*(\.|\. | )(\d{1,4})',
            str_re_form)
        match_no_day = re.search(
            '(\d{1,2}\.|Jan|Jän|Feb|Mär|Apr|Mai|Jun|Jul|Aug|Sep|Okt|Nov|Dez)\w*(\.|\. | )(\d{1,4})', str_re_form)
