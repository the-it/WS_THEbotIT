...
class TestTemplateHandler(TestCase):
    ...
    def test_without_key(self):
        test_string_12_no_key = (
            "{{" + test_title + "|" + test_string_argument_1_no_key + "|" + test_string_argument_2 + "}}"
        )
    ...
    def test_template_in_template(self):
        ...
        test_string_12_template = (
            "{{" + test_title + "|" + test_string_argument_template + "|" + test_string_argument_2 + "}}"
        )
        ...
        test_string_12_template_no_key = (
            "{{" + test_title + "|" + test_string_argument_1_template + "|" + test_string_argument_2 + "}}"
        )
    ...
    def test_set_title(self):
        test_string_12_test_title = (
            "{{" + test_title_test + "|" + test_string_argument_1 + "|" + test_string_argument_2 + "}}"
        )
        handler = TemplateHandler(test_string_12_simple)
    ...
    def test_link_with_text(self):
        ...
        test_string_12_link = (
            "{{" + test_title + "|" + test_string_argument_1_no_key + "|" + test_string_argument_2_link + "}}"
        )
        ...
        test_string_12_link_no_key = (
            "{{" + test_title + "|" + test_string_argument_1_no_key + "|" + test_string_argument_link + "}}"
        )
    ...
    def test_second_equal(self):
        ...
        test_string_second_equal = (
            "{{" + test_title_test + "|" + test_string_argument_1 + "|" + test_string_argument_second_equal + "}}"
        )
    ...
    def test_bug_authorlist(self):
        test_string_argument_bug = (
            'STERBEDATUM = 2. Januar < ref name = "adp" / > oder 31. Januar '
        ...
        test_string_argument_bug = (
            'GEBURTSDATUM=1783 < ref name = "EB" >  Encyclopaedia Britannica.  '
        ...
        test_string_argument_bug = (
            "GEBURTSORT=Klein Flottbek (heute zu [[Hamburg]])|STERBEDATUM=28. Oktober 1929|STERBEORT=[[Rom]]"
        )
        test_string_bug = "{{" + test_title_test + "|" + test_string_argument_1 + "|" + test_string_argument_bug + "}}"
        ...
        test_string_argument_bug = (
            "ALTERNATIVNAMEN = Carl Biedermann; Friedrich Karl Biedermann; "
        ...
        test_string_argument_bug = (
            "SONSTIGES=Pächter der [[w:Harste|Domäne Harste]], "
    ...
    def test_bug_poemlist(self):
        ...
        self.assertEqual(
            [
                {"key": None, "value": "[I] Schmutztitel"},
                {"key": None, "value": "Mittelalterliches Hausbuch 1887 0001.jpg"},
            ],
            real_dict,
        )
