...
class TestPetScan(TestCase):
    ...
    def test_construct_cat_string(self):
        ...
        self.assertEqual(
            "neg1\r\nneg+2\r\nneg3", self.petscan._construct_list_argument(self.petscan.categories["negative"])
        )
    ...
    def test_construct_options(self):
        self.petscan.options = {"max_age": "1234", "get_q": "1", "show_redirects": "yes"}
    ...
    result_of_searcher: ClassVar[list[dict[str, Any]]] = [
        {
            "id": 42,
            "len": 42,
            "n": "page",
        ...
        },
        {
            ...
            "nstext": "",
            "title": "RE:Lemma3",
            "touched": "19990101232359",
        },
    ]

    result_of_searcher_max_age: ClassVar[list[dict[str, Any]]] = [
        {
            "id": 42,
            "len": 42,
            "n": "page",
    ...
    def test_get_combined_lemmas_old_lemmas(self):
        ...
        petscan_mock.return_value = self.result_of_searcher
        compare(
            ([":RE:Lemma2", ":RE:Lemma3", ":RE:Lemma1"], 2),
            self.petscan.get_combined_lemma_list({":RE:Lemma1": "20010101232359"}),
        )
        compare(
            ([":RE:Lemma2", ":RE:Lemma1", ":RE:Lemma3"], 1),
    ...
    def test_get_combined_with_max_age(self):
        ...
        compare(
            ([":RE:Lemma4", ":RE:Lemma1", ":RE:Lemma2", ":RE:Lemma3"], 4),
            self.petscan.get_combined_lemma_list({}, timeframe=42),
        )
        petscan_mock.side_effect = [self.result_of_searcher, self.result_of_searcher_max_age]
        compare(
            ([":RE:Lemma4", ":RE:Lemma2", ":RE:Lemma3", ":RE:Lemma1"], 3),
